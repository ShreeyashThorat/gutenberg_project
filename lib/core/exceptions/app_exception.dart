...
import 'package:gutenberg_project/core/exceptions/colored_log.dart';
...
class TooManyRequestException extends AppException {
  TooManyRequestException([String? message, String? url])
    : super(
        ...
        message: 'You have made more requests per second than you are allowed.',
...
class DioConnectionException extends AppException {
  ...
  }) : super(exceptionType: 'DioConnectionException');
}
